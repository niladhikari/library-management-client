...
const Contact = () => {
  ...
  return (
    <div className="my-20 px-5 md:px-0" id="contact">
      <h1 className="text-5xl font-bold text-accent text-center  mb-10">
        Contact Us
      </h1>
      <div className="flex flex-wrap items-center justify-around">
        <div className="md:w-3/12">
          ...
          <p className="flex items-center gap-2 my-3">
            ...
            <span className="text-gray-400">niladhikari@gmail.com</span>
          </p>
          <p className="flex items-center gap-2 my-3">
            <span className="text-accent text-2xl">
              <FaPhoneAlt />
            ...
            <span className="text-gray-400">0160127050</span>
          </p>
        </div>
        <div className="md:w-3/6">
          <form ref={form} onSubmit={sendEmail}>
            ...
            <input
              type="submit"
              className="px-5 py-2 rounded-xl bg-blue-300 text-black font-bold mt-5"
            ></input>
          </form>
        </div>
      </div>
